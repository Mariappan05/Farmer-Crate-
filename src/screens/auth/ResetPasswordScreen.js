 ...
 * React Native conversion of Flutter Repass.dart
 *
 * Params: { email }
 * - New password + Confirm password with visibility toggle
 * - Password strength indicator (8+ chars, uppercase, lowercase, number, special)
 * - Calls resetPassword(email, newPassword)
 * - On success navigates to Login with success alert
...
/* ──────────────────────────────────────────────────────────────────────────
 * Password strength rules (matches Flutter Repass.dart)
 * ────────────────────────────────────────────────────────────────────────── */
        ...
        >
          ...
          <Animated.View style={[styles.headerSection, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
            <View style={styles.logoCircle}>
              <Ionicons name="lock-closed-outline" size={44} color="#388E3C" />
            </View>
...
/* ──────────────────────────────────────────────────────────────────────────
 * Styles – matches Flutter Repass.dart green gradient theme
 * ────────────────────────────────────────────────────────────────────────── */
